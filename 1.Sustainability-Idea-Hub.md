...
| 3 | Create Event | Hosting or creating a new event |
| 4 | Public Free Event Join | Joining a public free event |
| 5 | Paid Event Payment | Completing payment for a paid event |
| 6 | Private Event Join Request | Requesting access to a private event |
| 7 | Host Approval Process | Host approving or rejecting requests |
| 8 | Dashboard Features | Overview of user dashboard functionality |
| 9 | Admin Moderation | Admin managing events and users |
| 10 | Event Reviews | Submitting and viewing event reviews |
