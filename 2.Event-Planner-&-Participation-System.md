...
**Planora** is a secure, JWT-protected web platform where registered users can create, manage, and participate in events. Events can be **Public or Private** and may include **registration fees**.
